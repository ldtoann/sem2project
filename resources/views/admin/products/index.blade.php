    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
                ...
                <a href="{{ route('admin.products.create') }}" class="btn btn-lg btn-upper " style="color: white; background-color: rgb(145,7,7);"> ADD PRODUCT </a>
                ...
                <table class="kt-datatable__table" style="display: block;">
                    <thead class="kt-datatable__head">
                        <tr class="kt-datatable__row">
                            ...
                            <th style="width: 10%;" class="kt-datatable__cell"><span>IMGS</span></th>
                            <th style="width: 15%;" class="kt-datatable__cell"><span>NAME</span></th>
                            <th style="width: 15%;" class="kt-datatable__cell"><span>DESC</span></th>
                            <th style="width: 10%;" class="kt-datatable__cell"><span>PRICE</span></th>
                            <th style="width: 5%;" class="kt-datatable__cell"><span>QTY</span></th>
                            <th style="width: 10%;" class="kt-datatable__cell"><span>CA_ID</span></th>
                    ...
                    <thead class="kt-datatable__head">
                        <tr class="kt-datatable__row">
                            ...
                            <th style="width: 10%;" class="kt-datatable__cell"><span>
                            ...
                            <th style="width: 15%;" class="kt-datatable__cell"><span>{{ $product->name }}</span></th>
                            <th style="width: 15%;" class="kt-datatable__cell"><span>{{ $product->desc }}</span></th>
                            <th style="width: 10%;" class="kt-datatable__cell"><span>{{ format_money($product->price) }}</span></th>
                            <th style="width: 5%; padding-left: 25px;" class="kt-datatable__cell"><span>{{ $product->quantity }}</span></th>
                            <th style="width: 10%;" class="kt-datatable__cell"><span>{{ $product->category->name }}</span></th>
                            <th style="width: 10%;" class="kt-datatable__cell"><span>{{ $product->created_at }}</span></th>
                            <th style="width: 10%;" class="kt-datatable__cell"><span>{{ $product->updated_at }}</span></th>
                            <th style="width: 5%;" class="kt-datatable__cell"><span><a type="submit" href="{{ route('admin.products.edit', $product->id) }}">EDIT</a></span></th>
