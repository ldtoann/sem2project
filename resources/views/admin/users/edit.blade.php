        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <form class="user" accordion="{{route('admin.users.update',$user->id)}}" method="POST">
                        {{csrf_field}}
                        {{method_field('PUT')}}
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" value="{{$user->name}}" class="form-control form-control-user" id="exampleFirstName"
