                    ...
                    {{ method_field('PUT') }}
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input class="name" value="{{ $user->name }}" type="text" class="form-control form-control-user" id="exampleFirstName" placeholder="Name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <input style="width: 50%;" name="role" value="{{ $user->role }}" type="role" class="form-control form-control-user" id="exampleInputRole" placeholder="role">
                        </div>
