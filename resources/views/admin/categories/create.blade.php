                                        ...
                                        <div class="kt-section__body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <h3 class="kt-section__title kt-section__title-sm"> CREATE CATEGORY</h3>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <button type="submit" class="btn btn-lg btn-upper" style="background-color: rgb(145,7,7); color:white; margin-left: 453px; padding: 10px 30px;">CREATE</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
